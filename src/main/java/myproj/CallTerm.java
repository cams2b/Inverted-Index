...
public class CallTerm {
    ...
    try (JobControllerClient jobControllerClient =
      ...
      HadoopJob hadoopJob =
          HadoopJob.newBuilder()
              .setMainJarFileUri("file:///home/cabeeche/Term.jar")  
  ...
  public static void callTop(String t) throws IOException, InterruptedException {
	  
	String ter = "gs://dataproc-staging-us-central1-1037520934349-n3dl9izu//index_out gs://dataproc-staging-us-central1-1037520934349-n3dl9izu//term_out ";
	ter = ter + t;
	submitHadoopFsJob(ter);
    ...
    String objectName = "term_out/part-r-00000";
    ...
    // The ID of your GCS object
    String obj0 = "term_out/part-r-00000";
    String obj1 = "term_out/_SUCCESS";
    String obj2 = "term_out/";
  ...
  public static String[][] termTable() throws IOException{
